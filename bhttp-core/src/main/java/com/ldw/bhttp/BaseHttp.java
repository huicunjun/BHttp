...
public class BaseHttp<T> {
    ...
    @NotNull
    public static BaseHttp postJson(@NotNull String s) {
        return new BaseHttp();
    }

    @NotNull
    public BaseHttp add(String k, Object v) {
        return this;
    }
   ...
   /* static class Factory<D> {
        ...
        return (T) Proxy.newProxyInstance(service.getClassLoader(), new Class<?>[]{service},
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, @Nullable Object[] args)
                        ...
                        BaseHttp<?> result = serviceMethodCache.get(method);
                        if (result != null) {
                            LogUtils.logd("缓存读取");
                        ...
                        synchronized (serviceMethodCache) {
                            ...
                            if (result == null) {
                                result = new BaseHttp(method, args, true);
    ...
    public BaseHttp<T> to(Activity activity) {
    ...
    public BaseHttp<T> to(androidx.lifecycle.Lifecycle lifecycle) {
        if (lifecycle != null) {
    ...
    public BaseHttp<T> to(Fragment fragment) {
